...
--> statement-breakpoint
DROP TABLE "Qestions";--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "InterviewQuestionResponse" ADD CONSTRAINT "InterviewQuestionResponse_interview_id_Interview_id_fk" FOREIGN KEY ("interview_id") REFERENCES "Interview"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "InterviewQuestionResponse" ADD CONSTRAINT "InterviewQuestionResponse_question_id_Questions_id_fk" FOREIGN KEY ("question_id") REFERENCES "Questions"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "InterviewQuestionResponse" ADD CONSTRAINT "InterviewQuestionResponse_response_id_Response_id_fk" FOREIGN KEY ("response_id") REFERENCES "Response"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
